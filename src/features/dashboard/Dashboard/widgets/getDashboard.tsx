  ...
  if (dashType === DashType.FUNDS) {
    layouts = {
      ...
      sm: [
        ...
        { i: "ReturnsTD", x: 0, y: 1, w: 8, ...getH(10) },
        { i: "ReturnsLast", x: 0, y: 2, w: 2, h: 6 },
        { i: "Buy/Sell", x: 0, y: 3, w: 8, ...getH(10) },
        { i: "EquityAndLeverage", x: 2, y: 1, w: 2, h: 6 },
        { i: "Categories", x: 0, y: 4, w: 5, h: 6 },
      ],
      xs: [
        {
          i: "FundsTiles",
        ...
        { i: "ReturnsLast", x: 0, y: 2, w: 1, ...getH(10) },
