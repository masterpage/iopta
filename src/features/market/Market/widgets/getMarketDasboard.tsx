...
export function getMarketDashboard(
  ...
  if (marketType === MarketType.MONITOR) {
    layouts = {
      xl: [
        { i: 'MarketOverview', x: 0, y: 0, w: 18, h: 1.32, static: true }, // TODO: Need to make this dynamic
      ...
      lg: [
        { i: 'MarketOverview', x: 0, y: 0, w: 12, h: 1.32, static: true }, // TODO: Need to make this dynamic
      ...
      md: [
        { i: 'MarketOverview', x: 0, y: 0, w: 8, h: 1.32, static: true }, // TODO: Need to make this dynamic
      ...
      sm: [
        { i: 'MarketOverview', x: 0, y: 0, w: 4, h: 2.31, static: true }, // TODO: Need to make this dynamic
      ...
      xs: [
        { i: 'MarketOverview', x: 0, y: 0, w: 1, h: 4.47, static: true }, // TODO: Need to make this dynamic
